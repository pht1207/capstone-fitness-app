...
const recommendedWorkouts = [
    ...
    {
        workoutName: " Arm Specialization",
        exercises: [
            {name: "Machine Preacher Curl", sets: "", reps:""},
            {name: "Machine Tricep Dip", sets: "", reps:""},
            {name: "Dumbbell Hammer Curl", sets: "", reps:""},
            {name: "Cable Tricep Extension", sets: "", reps: ""}
        ]
    },

    {
        workoutName: " Quad Specialization",
        exercises: [
